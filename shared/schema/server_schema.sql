...
CREATE TABLE ops_operator_sessions (
    id TEXT PRIMARY KEY,
...
CREATE TABLE protected_session_ops_events (
...
CREATE TABLE protected_session_ops_snapshots (
    id TEXT PRIMARY KEY,
    environment TEXT NOT NULL,
...
CREATE INDEX idx_product_sessions_account_id ON product_sessions(account_id);
CREATE INDEX idx_product_sessions_auth_session_id ON product_sessions(auth_session_id);
...
CREATE INDEX idx_ops_operator_sessions_environment ON ops_operator_sessions(environment);
CREATE INDEX idx_ops_operator_sessions_expires_at ON ops_operator_sessions(expires_at);
CREATE INDEX idx_protected_session_ops_events_environment ON protected_session_ops_events(environment);
CREATE INDEX idx_protected_session_ops_events_occurred_at ON protected_session_ops_events(occurred_at);
CREATE INDEX idx_protected_session_ops_events_event_type ON protected_session_ops_events(event_type);
CREATE INDEX idx_protected_session_ops_events_session_id ON protected_session_ops_events(session_id);
CREATE INDEX idx_protected_session_ops_events_user_id ON protected_session_ops_events(user_id);
CREATE INDEX idx_protected_session_ops_events_domain ON protected_session_ops_events(domain);
CREATE INDEX idx_protected_session_ops_events_worker_id ON protected_session_ops_events(worker_id);
CREATE INDEX idx_protected_session_ops_events_reason_code ON protected_session_ops_events(reason_code);
CREATE INDEX idx_protected_session_ops_snapshots_environment ON protected_session_ops_snapshots(environment);
CREATE INDEX idx_protected_session_ops_snapshots_recorded_at ON protected_session_ops_snapshots(recorded_at);
